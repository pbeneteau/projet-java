...
public final class Menu {
    ...
    private void choisirModeDeTri() {
        ...
        switch (choix) {
            case 1:
                triParDefaut = TriEleves.identifiant;
                break;
            case 2:
                triParDefaut = TriEleves.mediane;
                break;
            case 3:
                triParDefaut = TriEleves.moyenne;
                break;
            case 4:
                triParDefaut = TriEleves.nom;
                break;
            case 5:
                triParDefaut = TriEleves.prenom;
                break;
            default:
                choisirModeDeTri();
        }
