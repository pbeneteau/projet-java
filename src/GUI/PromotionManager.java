...
public class PromotionManager extends javax.swing.JFrame {
    ...
    PromotionManager() {
        ...
        if (Globals.currentPromotion == null)
            Globals.currentPromotion = Promotion.getListePromos().get(0);

        if (Globals.currentPromotion != null) {
            PromotionManagerOperations operations = new PromotionManagerOperations();
            operations.displayStudentPromo(Globals.currentPromotion, elevesTable);
            operations.genererComboboxPromotions(promotionCombobox, elevesTable);
            operations.enableSearchBar(barreDeRecherche, elevesTable, modifEleveB);
            operations.genererComboboxTri(triCombobox, elevesTable);
            operations.linkEditTableButton(modifEleveB, elevesTable);
            operations.displayStudentInfoDoubleClic(elevesTable);
        }
        int total = 0;
    ...
    private void initComponents() {
        ...
        javax.swing.JButton retourB = new javax.swing.JButton();
        javax.swing.JButton creerEleve = new javax.swing.JButton();
        triCombobox = new javax.swing.JComboBox<>();
        javax.swing.JLabel jLabel3 = new javax.swing.JLabel();
        toggleSensTriB = new javax.swing.JToggleButton();
        javax.swing.JButton supprEleveB = new javax.swing.JButton();
        modifEleveB = new javax.swing.JButton();
        javax.swing.JButton diagMoyB = new javax.swing.JButton();
        javax.swing.JButton diagNbEleve = new javax.swing.JButton();
        javax.swing.JLabel jLabel4 = new javax.swing.JLabel();
        javax.swing.JLabel jLabel5 = new javax.swing.JLabel();
        javax.swing.JButton diagStatsPromoB = new javax.swing.JButton();
        javax.swing.JButton diagAppreciationB = new javax.swing.JButton();
    ...
    private void promotionComboboxActionPerformed(java.awt.event.ActionEvent evt) {
    }
     ...
     * @param evt
     */
    private void retourBClick(java.awt.event.ActionEvent evt) {

        if (!MainMenu.menu.isVisible()) {
     ...
     * @param evt
     */
    private void createStudentActionPerformed(java.awt.event.ActionEvent evt) {

        StudentGenerator generateurEleve = new StudentGenerator();
        generateurEleve.promoTF.setText(Globals.currentPromotion.getNom());
     ...
     * @param evt
     */
    private void toggleSensTriBActionPerformed(java.awt.event.ActionEvent evt) {
        // isSelected() permet de voir si le bouton est enfoncé
        if (toggleSensTriB.isSelected()) {
            toggleSensTriB.setText("Ordre : décroissant");
            Globals.ascendingSort = false;
        } else {
            toggleSensTriB.setText("Ordre : croissant");
            Globals.ascendingSort = true;
        }
        PromotionManagerOperations operations = new PromotionManagerOperations();
        operations.displaySortedCurrentPromotion(elevesTable);
    }
     ...
     * @param evt
     */
    private void deleteStudentBActionPerformed(java.awt.event.ActionEvent evt) {

        int id = (Integer) elevesTable.getValueAt(elevesTable.getSelectedRow(), 0);
        Eleve e = Globals.currentPromotion.rechercherEleve(id);
        Globals.currentPromotion.getEleves().remove(e);
     ...
     * @param evt
     */
    private void editStudentBClick(java.awt.event.ActionEvent evt) {

        int id = (Integer) elevesTable.getValueAt(elevesTable.getSelectedRow(), 0);
        Eleve e = Globals.currentPromotion.rechercherEleve(id);
        if (e != null) {
            // On ouvre une fenêtre qui gère les modifications d'un élève
            EditStudent modEleve = new EditStudent(e);
    ...
    private void diagNbEleveActionPerformed(java.awt.event.ActionEvent evt) {
        new CamembertNombreEleveParPromo(Promotion.getListePromos());
    }

    private void diagAppreciationBActionPerformed(java.awt.event.ActionEvent evt) {
        new CamembertAppreciationPromo(Globals.currentPromotion);
    }

    private void diagMoyBActionPerformed(java.awt.event.ActionEvent evt) {
        new DiagrammeBatonMoyennePromotion(Promotion.getListePromos());
    }

    private void diagStatsPromoBActionPerformed(java.awt.event.ActionEvent evt) {
